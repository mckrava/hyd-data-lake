...
export type GetLbpPoolDataQueryVariables = Exact<{
  filter?: InputMaybe<LbpPoolFilter>;
}>;


export type GetLbpPoolDataQuery = { __typename?: 'Query', lbpPools?: { __typename?: 'LbpPoolsConnection', nodes: Array<{ __typename?: 'LbpPool', assetAId: number, assetBId: number, end?: number | null, fee: Array<number | null>, feeCollector?: string | null, finalWeight: number, id: string, initialWeight: number, owner: string, paraChainBlockHeight: number, poolAddress: string, relayChainBlockHeight: number, repayTarget: any, start?: number | null, weightCurve: string, lbpPoolAssetsDataByPoolId: { __typename?: 'LbpPoolAssetsDataConnection', nodes: Array<{ __typename?: 'LbpPoolAssetsDatum', assetId: number, balances: any, id: string, paraChainBlockHeight: number, relayChainBlockHeight: number, poolId?: string | null } | null> } } | null> } | null };


export const GetLbpPoolData = gql`
